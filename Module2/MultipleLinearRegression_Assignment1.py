...
print('avg sq beds', np.mean(train_data['bedrooms_squared']))
print('avg bed bath', np.mean(train_data['bed_bath_rooms']))
print('avg log sqft', np.mean(train_data['log_sqft_living']))
print('avg lat long', np.mean(train_data['lat_plus_long']))
